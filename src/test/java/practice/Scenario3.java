...
WebDriver driver = new EdgeDriver();
		...
		driver.findElement(By.id("email")).sendKeys("vinoths0507@gmail.com");
		driver.findElement(By.id("mobile")).sendKeys("9517538526");
		driver.findElement(By.xpath("//input[@name=\"birthday\"]")).sendKeys("1994-07-05");
		driver.findElement(By.xpath("//input[@class=\"crmButton small save\"]")).click();
		String ContactHeader = driver.findElement(By.xpath("//span[@class=\"dvHeaderText\"]")).getText();
		System.out.println(ContactHeader);
	
		if (ContactHeader.contains("S")) 
		{
